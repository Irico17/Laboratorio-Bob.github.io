...
const rawChart = `flowchart LR
    ...
    B -->|"Checkout Code"| C{"Bob Shell CLI"}
    C -->|"Prompts + Skills"| D["IBM LLMs"]
    ...
    style D fill:#001d6c,stroke:#001d6c,stroke-width:2px,color:#fff
`;
    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: '4rem' }}>
      ...
      <StructuredListWrapper>
        ...
        <StructuredListBody>
          ...
          <StructuredListRow>
            <StructuredListCell><strong>Bob Shell CLI</strong></StructuredListCell>
            <StructuredListCell>El orquestador de IA local. Toma el código fuente, lee las reglas (<em>Skills</em>) del repositorio, empaqueta todo en un <em>prompt</em> masivo y lo envía a IBM.</StructuredListCell>
          </StructuredListRow>
          <StructuredListRow>
            <StructuredListCell><strong>IBM LLMs</strong></StructuredListCell>
            <StructuredListCell>Modelos fundacionales que procesan el código, detectan anomalías y generan la respuesta (diagnóstico o código parcheado).</StructuredListCell>
          </StructuredListRow>
          <StructuredListRow>
